...
description: The research equivalent of codebase-analyzer. Use this when wanting to deep dive on a research topic or analyze documentation in depth. Extracts high-value insights from documentation.
